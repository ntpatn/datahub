...
# URL และ base
url = "https://phyblas.hinaboshi.com/saraban/opencvpython"
...
# //u[contains(text(),"ส่วนที่")]/following-sibling::div[1]/a[@target="_blank" and contains(., 'บทที่')]
for u_tag in soup.find_all("u"):
    if "ส่วนที่" in u_tag.get_text(strip=True):
...
path = get_save_path("source_phyblas_files_opencv.csv", "data")
